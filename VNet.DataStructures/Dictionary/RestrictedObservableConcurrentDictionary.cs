...
{
    public class RestrictedObservableConcurrentDictionary<TKey, TValue> : ObservableDictionaryBase<TKey,TValue>,
                                                                ...
                                                                where TValue : notnull
    {
        ...
        #region Constructors
        public RestrictedObservableConcurrentDictionary()
        {
            _dictionary = new ConcurrentDictionary<TKey, TValue>();
        }

        public RestrictedObservableConcurrentDictionary(IEnumerable<KeyValuePair<TKey, TValue>> collection)
        {
            _dictionary = new ConcurrentDictionary<TKey, TValue>(collection);
        }

        public RestrictedObservableConcurrentDictionary(IEqualityComparer<TKey>? comparer)
        {
            _dictionary = new ConcurrentDictionary<TKey, TValue>(comparer);
        }

        public RestrictedObservableConcurrentDictionary(IDictionary<TKey, TValue> dictionary)
        {
            _dictionary = new ConcurrentDictionary<TKey, TValue>(dictionary);
        }

        public RestrictedObservableConcurrentDictionary(IEnumerable<KeyValuePair<TKey, TValue>> collection, IEqualityComparer<TKey>? comparer)
        {
            _dictionary = new ConcurrentDictionary<TKey, TValue>(collection, comparer);
        }

        public RestrictedObservableConcurrentDictionary(IDictionary<TKey, TValue> dictionary, IEqualityComparer<TKey>? comparer)
        {
        ...
        public TValue AddOrUpdate(TKey key, Func<TKey, TValue> addValueFactory, Func<TKey, TValue, TValue> updateValueFactory)
        {
            ...
            if (addValueFactory.GetType() != _restrictedType) throw new ArgumentException("All types in a restricted dictionary must match.");
