...
{
    public class RestrictedObservableDictionary<TKey, TValue> : ObservableDictionaryBase<TKey, TValue>,
                                                            ...
                                                            where TValue : notnull
    {
        ...
        #region Constructors
        public RestrictedObservableDictionary()
        {
            _dictionary = new Dictionary<TKey, TValue>();
        }

        public RestrictedObservableDictionary(int capacity)
        {
            _dictionary = new Dictionary<TKey, TValue>(capacity);
        }

        public RestrictedObservableDictionary(IEnumerable<KeyValuePair<TKey, TValue>> collection)
        {
            _dictionary = new Dictionary<TKey, TValue>(collection);
        }

        public RestrictedObservableDictionary(IEqualityComparer<TKey>? comparer)
        {
            _dictionary = new Dictionary<TKey, TValue>(comparer);
        }

        public RestrictedObservableDictionary(IDictionary<TKey, TValue> dictionary)
        {
            _dictionary = new Dictionary<TKey, TValue>(dictionary);
        }

        public RestrictedObservableDictionary(int capacity, IEqualityComparer<TKey>? comparer)
        {
            _dictionary = new Dictionary<TKey, TValue>(capacity, comparer);
        }

        public RestrictedObservableDictionary(IEnumerable<KeyValuePair<TKey, TValue>> collection, IEqualityComparer<TKey>? comparer)
        {
            _dictionary = new Dictionary<TKey, TValue>(collection, comparer);
        }

        public RestrictedObservableDictionary(IDictionary<TKey, TValue> dictionary, IEqualityComparer<TKey>? comparer)
        {
