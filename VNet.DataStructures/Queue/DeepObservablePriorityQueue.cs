...
{
    public class DeepObservablePriorityQueue<TItem, TPriority> : DeepObservableDoubleTypeCollectionBase<TItem, TPriority>
    {
        private readonly PriorityQueue<TItem, TPriority> _queue;


        #region Constructors
        public DeepObservablePriorityQueue()
        {
            _queue = new PriorityQueue<TItem, TPriority>();
        }

        public DeepObservablePriorityQueue(IComparer<TPriority>? comparer)
        {
            _queue = new PriorityQueue<TItem, TPriority>(comparer);
        }

        public DeepObservablePriorityQueue(IEnumerable<(TItem Element, TPriority Priority)> items)
        {
        ...
        public DeepObservablePriorityQueue(int initialCapacity)
        {
            _queue = new PriorityQueue<TItem, TPriority>(initialCapacity);
        }

        public DeepObservablePriorityQueue(int initialCapacity, IComparer<TPriority>? comparer)
        {
