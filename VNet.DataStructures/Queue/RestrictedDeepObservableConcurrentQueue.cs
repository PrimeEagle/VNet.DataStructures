...
{
    public class RestrictedDeepObservableConcurrentQueue<T> : DeepObservableSingleTypeCollectionBase<T>, IEnumerable<T>
    {
        ...
        #region Constructors
        public RestrictedDeepObservableConcurrentQueue()
        {
            _queue = new ConcurrentQueue<T>();
        }

        public RestrictedDeepObservableConcurrentQueue(IEnumerable<T> enumerable)
        {
