...
{
    public class RestrictedObservablePriorityQueue<TItem, TPriority> : ObservableDoubleTypeCollectionBase<TItem, TPriority>
    {
        ...
        #region Constructors
        public RestrictedObservablePriorityQueue()
        {
            _queue = new PriorityQueue<TItem, TPriority>();
        }

        public RestrictedObservablePriorityQueue(IComparer<TPriority>? comparer)
        {
            _queue = new PriorityQueue<TItem, TPriority>(comparer);
        }

        public RestrictedObservablePriorityQueue(IEnumerable<(TItem Element, TPriority Priority)> items)
        {
        ...
        public RestrictedObservablePriorityQueue(int initialCapacity)
        {
            _queue = new PriorityQueue<TItem, TPriority>(initialCapacity);
        }

        public RestrictedObservablePriorityQueue(int initialCapacity, IComparer<TPriority>? comparer)
        {
        ...
        public TItem EnqueueDequeue(TItem item, TPriority priority)
        {
            ...
            if (!_queue.TryPeek(out var oldItem, out var oldPriority)) return oldItem;
