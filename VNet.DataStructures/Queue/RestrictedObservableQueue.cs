...
{
    public class RestrictedObservableQueue<T> : ObservableSingleTypeCollectionBase<T>, IEnumerable<T>
    {
        ...
        #region Constructors
        public RestrictedObservableQueue()
        {
            _queue = new Queue<T>();
        }

        public RestrictedObservableQueue(IEnumerable<T> enumerable)
        {
            _queue = new Queue<T>(enumerable);
        }

        public RestrictedObservableQueue(int capacity)
        {
