...
{
    public class DeepObservableStack<T> : DeepObservableSingleTypeCollectionBase<T>,
                                          IEnumerable<T>
                                          where T : notnull, IComparable<T>
    {
        ...
        #region Constructors
        public DeepObservableStack()
        {
            _stack = new Stack<T>();
        }

        public DeepObservableStack(IEnumerable<T> enumerable)
        {
            _stack = new Stack<T>(enumerable);
        }

        public DeepObservableStack(int capacity)
        {
