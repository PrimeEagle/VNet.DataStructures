...
{
    public class RestrictedObservableStack<T> : ObservableSingleTypeCollectionBase<T>, IEnumerable<T> where T : notnull
    {
        ...
        #region Constructors
        public RestrictedObservableStack()
        {
            _stack = new Stack<T>();
        }

        public RestrictedObservableStack(IEnumerable<T> enumerable)
        {
            _stack = new Stack<T>(enumerable);
        }

        public RestrictedObservableStack(int capacity)
        {
