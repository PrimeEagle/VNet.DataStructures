...
{
    public class DeepObservableConcurrentStack<T> : DeepObservableSingleTypeCollectionBase<T>,
                                                    IEnumerable<T>
                                                    where T : notnull, IComparable<T>
    {
        ...
        #region Constructors
        public DeepObservableConcurrentStack()
        {
            _stack = new ConcurrentStack<T>();
        }

        public DeepObservableConcurrentStack(IEnumerable<T> enumerable)
        {
